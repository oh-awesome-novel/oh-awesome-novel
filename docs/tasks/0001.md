...
- [Retire StoryForge Current Naming](../superpowers/plans/2026-06-10-retire-storyforge-current-naming.md)

These plans are documentation/architecture guardrails. They do not make this completed foundation task a code implementation task.
