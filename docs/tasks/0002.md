...
- [Align Monorepo Source Layout](../superpowers/plans/2026-06-10-align-monorepo-source-layout.md)

This plan confirms future work should stay in `packages/*`, `apps/*`, and `__test__/*`, not the obsolete root `src/` layout.
